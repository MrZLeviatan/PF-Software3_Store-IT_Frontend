...
export class CarritoCompraService {
  ...
  agregarCantidad(item: ModificarCantidadItemsDto): Observable<MensajeDto<string>> {
    return this.http.post<MensajeDto<string>>(`${this.baseUrl}/agregar-cantidad`, item);
  }

  quitarCantidad(item: ModificarCantidadItemsDto): Observable<MensajeDto<string>> {
    return this.http.post<MensajeDto<string>>(`${this.baseUrl}/quitar-cantidad`, item);
  }
